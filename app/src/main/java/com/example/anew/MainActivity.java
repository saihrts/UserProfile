...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnQuest.setOnClickListener(v -> startActivity(new Intent(MainActivity.this, QuestActivity.class)));

        LinearLayout btnPortfolio = findViewById(R.id.btnportfolio);
        btnPortfolio.setOnClickListener(v -> startActivity(new Intent(MainActivity.this, ItemsActivity.class)));
        ...
        btnWallet.setOnClickListener(v -> startActivity(new Intent(MainActivity.this, WalletActivity.class)));
    }
